  ...
  (setq-default
   ...
   '(html
     ...
     (xclipboard :variables
                 xclipboard-copy-command "utf8clip.exe")
     helm
     slack
     ;; lsp
     markdown
...
before packages are loaded."
  ;; Go to new fucking line at 80 column
...
(setq org-agenda-files
      '("~/org/"))
;; If I want to add the TODOs.org file for each project automatically to the agenda view, then:
